...
import com.popcorn.api.moviesdb.dto.SearchMovie;
import org.springframework.web.client.RestTemplate;

import java.util.List;

public class SearchService {
    public static List<SearchMovie> getResults(String searchString) {
        ...
        List<SearchMovie> results = searchResponse.getResults();
    ...
    private class SearchResponse {
        ...
        public SearchResponse(String page, String total_results, String total_pages, List<SearchMovie> results) {
